    ...
    <div>
      <div className="wrap">
        <form>
          ...
          <div>
            <input id="pi" type="url" placeholder="Your Website*"></input>

            <input id="pi" type="url" placeholder="GitHub*"></input>
          </div>

          <div>
            <input id="pi" type="url" placeholder="Linked in*"></input>
            <input id="pi" type="url" placeholder="Twitter*"></input>
          </div>
          <div>
            <input id="pi" type="url" placeholder="Facebook*"></input>
